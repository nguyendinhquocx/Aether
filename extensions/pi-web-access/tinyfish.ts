...
interface WebSearchConfig {
	...
	tinyfishBaseUrl?: unknown;
}

function baseUrlOverride(): string | null {
	return normalizeBaseUrlOverride(loadConfig().tinyfishBaseUrl);
}

function searchEndpoint(): string {
	return resolveEndpointUrl(TINYFISH_SEARCH_URL, baseUrlOverride());
}

function fetchEndpoint(): string {
	return resolveEndpointUrl(TINYFISH_FETCH_URL, baseUrlOverride(), true);
}
